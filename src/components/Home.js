  ...
  return (
    <div className="flex flex-col items-center bg-white dark:bg-gray-900 min-h-screen">
      ...
      <div className="md:w-1/2 relative -mt-10">
          ...
          />
          <div className="rounded-lg absolute top-2/4 left-2/4 transform -translate-x-2/4 -translate-y-2/4 bg-yellow-500 dark:bg-yellow-600 rounded-t-full w-96 h-4/5 mt-24" ml-8/>
        </div>

        <div className="md:w-2/3 py-8 md:py-0 m-4">
          <div className="flex flex-col justify-center h-full">
            <div className="flex justify-between items-center mb-6">
              <h1 className="text-4xl md:text-6xl sm:text-center text-center font-bold text-yellow-500  dark:text-yellow-600 sm:mt-8">
          ...
          This event marks a significant milestone in my life, and I would be
          honored if you could join me in celebrating this achievement on 13TH
          May.
         </p>
        <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
          <h2 className="text-xl font-bold mb-4 text-red-700 dark:text-red-700">
           ...
           <p className="text-lg mb-4">
            I will be hosting an informal graduation
             party at Pablo's Pizza Mexican Eatery Mexobar, starting at 1.00 pm.
          </p>
          <p className="text-lg mb-4">
             Please note that everyone is expected
            to pay for their own meal and drink.
          </p>
           <p className="text-lg mb-4">
            To help with planning, I kindly request that you RSVP by 10TH
            May. Your response will allow me to make adequate arrangements for
             the event.
           </p>
           </div>
            </div>
